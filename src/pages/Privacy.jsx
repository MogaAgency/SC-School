...
const sections = [
  ...
  {
    title: 'حساب المنصة',
    body: 'لو عملت حساب على منصة ولي الأمر بنحتفظ بالإيميل، اسم ورقم ولي الأمر، واسم ورقم الطالب، وبنضيف عليهم الكورسات اللي الطالب مسجّل فيها. البيانات دي بتتخزّن على خدمة Supabase على سيرفرات في أوروبا، ومحمية بحيث كل ولي أمر يشوف بيانات عيلته بس. الدخول بيتم بكود مؤقت على الإيميل من غير باسورد، فمفيش باسورد بيتخزّن عندنا.',
  },
  {
